-- CreateEnum
CREATE TYPE "PlanRole" AS ENUM ('STUDENT', 'INSTITUTION');
...
CREATE TABLE "Plan" (
    ...
    "priceMonthlyFcfa" INTEGER,
    "priceYearlyFcfa" INTEGER,
...
-- CreateIndex
CREATE UNIQUE INDEX "Plan_role_code_key" ON "Plan"("role", "code");
