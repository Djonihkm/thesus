...
export function DeleteMemoireButton({ memoireId, title }: { memoireId: string; title: string }) {
            ...
            >
              ...
              >
                ...
                <p className="mt-3 text-sm leading-relaxed text-ink-muted">
                  « {title} » sera définitivement supprimé. Cette action est irréversible : le
                  fichier et les données associées seront supprimés.
                </p>
