...
//
// Règle d'accès partagée à la vue document d'un mémoire (éditeur TipTap, room
// Liveblocks, images extraites) — utilisée à la fois par la route d'auth Liveblocks et
// par la route de service des images, pour ne pas dupliquer (et risquer de faire
// diverger) la logique d'autorisation.
