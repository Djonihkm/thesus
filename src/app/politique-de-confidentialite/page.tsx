        ...
        <div className="mt-10 space-y-10 text-ink-muted">
          ...
          <section>
            ...
            <p className="mt-3 leading-7">
              ...
              pour Thesus. Cette politique explique comment vos données
              sont collectées et utilisées.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3 leading-7">
              Les mémoires et documents envoyés sur Thesus restent
              confidentiels et ne sont pas accessibles aux autres utilisateurs.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3 leading-7">
              ...
              Les résultats générés sont des recommandations et doivent être
              vérifiés avant utilisation académique.
            </p>
          </section>
